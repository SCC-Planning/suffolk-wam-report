...
Table \@ref(tab:tab1) shows all waste managed in Suffolk, and the Waste Planning Authority (WPA) from which the waste originated. It shows the figures for all our nearest neighbours and 'All Other WPAs'.
...
Table \@ref(tab:tab2) is a further breakdown of Table \@ref(tab:tab1) showing all waste sent to landfill managed in Suffolk, and the Waste Planning Authority (WPA) from which the waste originated.
...
This is a large change in the flow of waste in Suffolk, however the reasons for this increase in 2021 net flow out of the county, are covered in Table \@ref(tab:tab5).
...
One remarkable rise from in Suffolk's waste sent to Norfolk from 2020 to 2021, is the increase in tonnage sent to Thetford Power Station, operated by EPR Thetford Limited.
