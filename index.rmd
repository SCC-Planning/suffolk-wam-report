...
```{r foodwastenearby, message = FALSE, ft.align = "center", tab.id = "foodwastenearby", label = "foodwastenearby", tab.cap = "source tbd"}
nearby_councils <- c(
...
A table of all authorities is provided in the appendix. We can summarise the national picture using summary statistics, which are provided here in Table \@ref(tab:foodwastesummary).

```{r foodwastesummary, message = FALSE, ft.align = "center", tab.id = "foodwastesummary", label = "foodwastesummary", tab.cap = "source tbd"}
...
By multiplying the total household waste collected, by the national food waste collection rates above, an estimated range is given in Figure \@ref(fig:foodwastepredicted).

```{r foodwastepredicted, fig.height = 4, fig.width = 8, fig.cap = "cap tbd"}
...
```
The totals displayed in Figure \@ref(fig:foodwastepredicted) are stated in Table \@ref(tab:foodwasteestimate). This shows the estimated tonnage of food waste, where the lowest estimate is equivalent to the lowest food waste collection rate in the county, low is equivalent to the 1st quartile in the country etc.

```{r foodwasteestimate, message = FALSE, ft.align = "center", tab.id = "foodwasteestimate", label = "foodwasteestimate", tab.cap = "source tbd"}
...
Suffolk's current AD treatment waste received will be covered in Section 4
