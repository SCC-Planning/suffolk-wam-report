...
wdi_totals <- get_wdi_totals(years_of_interest)
...
operators_ranked <- get_operators_ranked(years_of_interest)
...
landfill_totals <- get_wdi_totals_by_site(years_of_interest)
...
wdi_origin <- get_waste_origin(years_of_interest)
...
wdi_landfill <- get_landfill_waste(years_of_interest)
...
wdi_export <- get_waste_destination(years_of_interest)
...
wdi_norfolk <- get_waste_between_wpas(
  years_of_interest,
  origin = "Suffolk",
  destination = "Norfolk"
)
