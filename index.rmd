...
wdi_thetford <- wamreport$wdi_all |> 
  dplyr::filter(
    `Origin WPA` == "Suffolk" &
      `Facility WPA` == "Norfolk" &
      Operator == "EPR Thetford Limited"
  )
...
Thetford Power Station is an Animal By-Products Incinerator, [which converts poultry litter into electricity](https://www.mreuk.com/thetford). It is in close proximity to Suffolk County border.
